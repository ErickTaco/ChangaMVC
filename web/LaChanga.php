...
<body style="margin: 0;font-family: sans-serif">
    ...
    <!-- Carousel wrapper -->
    <div id="carouselDarkVariant" class="container carousel slide carousel-fade carousel-dark" data-mdb-ride="carousel" data-aos="zoom-out" data-aos-duration="4000">
        <!-- Indicators -->
        <!-- Inner -->
        ...
        <tbody>
            <tr>
                ...
                <td class="p-5">
                    ...
                    <?php foreach ($filas as $row) { ?> <?php echo $row['Vision']; ?> <?php } ?>
                </td>
